...
contract SolveReentranceTwoScript is Script {

    Reentrance reentranceChallenge = Reentrance( payable(address(0x8464135c8F25Da09e49BC8782676a84730C318bC)) );
    ReentranceAttacker reentranceAttacker = ReentranceAttacker( payable(address(0x663F3ad617193148711d28f5334eE4Ed07016602)) );
